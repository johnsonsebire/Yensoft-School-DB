                    ...
                    <table class="table table-hover text-nowrap table-striped table-vcenter mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('images/xs/avatar1.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <img src="{{asset('images/xs/avatar2.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                <td>
                                    <img src="{{asset('images/xs/avatar3.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                <td>
                                    <img src="{{asset('images/xs/avatar4.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                <td>
                                    <img src="{{asset('images/xs/avatar5.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                </td>
                            </tr>
                        </tbody>
                    </table>
