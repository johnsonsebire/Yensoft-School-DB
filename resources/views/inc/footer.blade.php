...
<!-- Start all plugin js -->
<script src="{{asset('bundles/counterup.bundle.js')}}" defer></script>
<script src="{{asset('bundles/apexcharts.bundle.js')}}" defer></script>
<script src="{{asset('bundles/summernote.bundle.js')}}" defer></script>

<!-- Start project main js  and page js -->
<script src="{{asset('js/core.js')}}" defer></script>
<script src="{{asset('js/page/index.js')}}" defer></script>
<script src="{{asset('js/page/summernote.js')}}" defer></script>
</body>
</html>
